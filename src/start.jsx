...
export default function StartPage() {
  ...
  ["XIE JINGXUAN",                          "GABRIEL LEE YU EN",              "Sharlene Tan Qin Ying",                  "Yeo Shu Axelia"],
  ...
  ["Ivaniuk Aleksandr",                     "Scott Travis Jayden",            "Ashton Lim Jing Kai",                    "Gong Xiyue"],
  ...
  ["GOH XIN NI & KYAL TARYAR LYNN MYAT @ JASPER LYNN MYAT", "Lim Wen Hong",   "Iresh Ramasamy",               "Aldo Djojorahardjo"],
  ["Phua Xuan Zhi Ethan & Kai Jonas Theolke","Isaac Woon Xin Wei","Chew Aorong Zavier",             "Kingsley"],
  ["Chin Wei Xin",                          "Astral",                         "Rayden",                                 "Rayson"],
  ...
  if (showHint >= 300) {
    ...
    alert(`Hint available in ${300 - showHint} seconds`)
  }
}
